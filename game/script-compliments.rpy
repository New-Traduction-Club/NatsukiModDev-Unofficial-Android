...
label player_compliments_start:
    ...
    call screen scrollable_choice_menu(compliment_menu_items, (__("Go back"), None), 400, "mod_assets/icons/compliments.png")
...
init 5 python:
    registerTopic(
        Topic(
            ...
            prompt=__("I think you're amazing!"),
...
init 5 python:
    registerTopic(
        Topic(
            persistent._compliment_database,
            prompt=__("I think you're beautiful!"),
...
init 5 python:
    registerTopic(
        Topic(
            persistent._compliment_database,
            prompt=__("I love how confident you are!"),
...
init 5 python:
    registerTopic(
        Topic(
            persistent._compliment_database,
            prompt=__("You're an inspiration to me!"),
...
init 5 python:
    registerTopic(
        Topic(
            persistent._compliment_database,
            prompt=__("I love your sense of style!"),
...
init 5 python:
    registerTopic(
        Topic(
            persistent._compliment_database,
            prompt=__("I love how thoughtful you are!"),
