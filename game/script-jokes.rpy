...
init python in jn_jokes:
    ...
    __registerJoke(JNJoke(
        ...
        display_name=__("Eating clocks"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_anime_animated",
        display_name=__("Anime"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_pirate_shower",
        display_name=__("Pirate hygiene"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_cinderella_soccer",
        display_name=__("Cinderella"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_blind_fish",
        display_name=__("Fish eyesight"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_skeleton_music",
        display_name=__("Skeletal music"),
        joke_category=JNJokeCategories.corny,
        conditional="persistent.jn_custom_music_unlocked"
    ))
    __registerJoke(JNJoke(
        label="joke_skeleton_communication",
        display_name=__("Skeletal communication"),
        joke_category=JNJokeCategories.corny,
        conditional="jn_jokes.getJoke('joke_skeleton_music').shown_count > 0"
    ))
    __registerJoke(JNJoke(
        label="joke_ocean_greeting",
        display_name=__("Ocean greetings"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_tractor_trailer",
        display_name=__("Tractor-trailer"),
        joke_category=JNJokeCategories.funny
    ))
    __registerJoke(JNJoke(
        label="joke_tentacle_tickles",
        display_name=__("Tentacles"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_basic_chemistry",
        display_name=__("Basic chemistry"),
        joke_category=JNJokeCategories.funny
    ))
    __registerJoke(JNJoke(
        label="joke_upset_cat",
        display_name=__("Upsetting a cat"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_cute_chicks",
        display_name=__("Cute chicks"),
        joke_category=JNJokeCategories.bad
    ))
    __registerJoke(JNJoke(
        label="joke_lumberjack_axeception",
        display_name=__("Lumberjacks"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_tallest_building",
        display_name=__("Tallest building"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_baking_baseball",
        display_name=__("Baking and baseball"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_soya_tofu",
        display_name=__("Tofu"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_distrust_atoms",
        display_name=__("Atomic theory"),
        joke_category=JNJokeCategories.funny
    ))
    __registerJoke(JNJoke(
        label="joke_running_latte",
        display_name=__("Barista"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_guitar_stringing_along",
        display_name=__("Guitarist"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_snek_maths",
        display_name=__("Snake mathematics"),
        joke_category=JNJokeCategories.bad
    ))
    __registerJoke(JNJoke(
        label="joke_balloonist_hot_air",
        display_name=__("Hot air"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_author_cover_story",
        display_name=__("Cover story"),
        joke_category=JNJokeCategories.funny
    ))
    __registerJoke(JNJoke(
        label="joke_wrapped_up_quickly",
        display_name=__("Packaging"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_carpentry_nailed_it",
        display_name=__("Nailed it"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_neutrons_no_charge",
        display_name=__("Neutrons"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_train_sound_track",
        display_name=__("Sound tracks"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_bored_typist",
        display_name=__("Typists"),
        joke_category=JNJokeCategories.bad
    ))
    __registerJoke(JNJoke(
        label="joke_regular_moovements",
        display_name=__("Cows and stairs"),
        joke_category=JNJokeCategories.bad
    ))
    __registerJoke(JNJoke(
        label="joke_rabbit_lottery",
        display_name=__("Rabbit lottery"),
        joke_category=JNJokeCategories.funny
    ))
    __registerJoke(JNJoke(
        label="joke_trees_logged_out",
        display_name=__("Logging out"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_con_crete",
        display_name=__("Con-crete"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_footless_snakes",
        display_name=__("Measuring snakes"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_bigger_ball",
        display_name=__("Ball sports"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_meeting_walls",
        display_name=__("Meeting walls"),
        joke_category=JNJokeCategories.bad
    ))
    __registerJoke(JNJoke(
        label="joke_hour_feeling",
        display_name=__("Clock and the watch"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_spotless_tigers",
        display_name=__("Tiger's stripes"),
        joke_category=JNJokeCategories.funny
    ))
    __registerJoke(JNJoke(
        label="joke_missing_bell",
        display_name=__("No bell"),
        joke_category=JNJokeCategories.funny
    ))
    __registerJoke(JNJoke(
        label="joke_cheesy_pizza",
        display_name=__("Pizza"),
        joke_category=JNJokeCategories.bad
    ))
    __registerJoke(JNJoke(
        label="joke_veggie_mood",
        display_name=__("Vegetarian moods"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_scarecrow_award",
        display_name=__("Scarecrows"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_sundae_school",
        display_name=__("School"),
        joke_category=JNJokeCategories.funny
    ))
    __registerJoke(JNJoke(
        label="joke_burned_tongue",
        display_name=__("Burned tongues"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_pointless_pencil",
        display_name=__("Pencils"),
        joke_category=JNJokeCategories.funny
    ))
    __registerJoke(JNJoke(
        label="joke_know_the_drill",
        display_name=__("The drill"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_can_do_attitude",
        display_name=__("Cannery"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_out_of_ctrl",
        display_name=__("Out of control"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_dishwashing",
        display_name=__("Dishwashing"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_escape_artists",
        display_name=__("Escape artist"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_shoemakers",
        display_name=__("Shoemakers"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_lead_times",
        display_name=__("Dog walkers"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_shark_literature",
        display_name=__("Shark literature"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_developers_committed",
        display_name=__("Developers"),
        joke_category=JNJokeCategories.funny
    ))
    __registerJoke(JNJoke(
        label="joke_shelved_plans",
        display_name=__("Plans"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_action_figures",
        display_name=__("Action"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_befriending_sharks",
        display_name=__("Befriending sharks"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_fisherman_broadcast",
        display_name=__("Fishermen video calls"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_lighthouse_keeper",
        display_name=__("Lighthouse keeper"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_bakers",
        display_name=__("Bakers"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_ravioli_pasta_way",
        display_name=__("Ravioli"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_spices",
        display_name=__("Spices"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_movie_theater_concessions",
        display_name=__("Movie theater"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_octo_puss",
        display_name=__("Eight-legged cat"),
        joke_category=JNJokeCategories.bad
    ))
    __registerJoke(JNJoke(
        label="joke_roller_blade",
        display_name=__("Shaving as a skater"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_psychic_medium",
        display_name=__("Psychic meals"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_ex_press_delivery",
        display_name=__("Ex-press"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_keymakers_lockstep",
        display_name=__("Keymakers"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_tube_piping_hot",
        display_name=__("Tube cuisine"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_entomology_programming",
        display_name=__("Entomology"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_booked_it",
        display_name=__("Author pulled over"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_sheep_flock",
        display_name=__("Cults"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_multiple_choice",
        display_name=__("Multiple choice"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_horse_hairstyles",
        display_name=__("Horse hairstyles"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_new_heights",
        display_name=__("Mountain climbers"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_coffee_grind",
        display_name=__("Instant coffee"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_butterfly",
        display_name=__("Butterflies"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_crampons",
        display_name=__("Ice climbers"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_frog_notes",
        display_name=__("Frog notes"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_sea_urchins",
        display_name=__("Urchins"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_airforce_wings",
        display_name=__("Air force"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_time_trial",
        display_name=__("Time trials"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_wolves_alphabet",
        display_name=__("Wolf education"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_sailor_shipshape",
        display_name=__("Sailors"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_seamstress_thread",
        display_name=__("Seamstress"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_sting_operation",
        display_name=__("Bee theft"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_sculptors_steak_marbled",
        display_name=__("Sculptors"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_rhetorical",
        display_name=__("Rhetorical"),
        joke_category=JNJokeCategories.confusing
    ))
    __registerJoke(JNJoke(
        label="joke_fuzz",
        display_name=__("Fuzz"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_restroom_comedian",
        display_name=__("Restroom comedian"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_glasses_framed",
        display_name=__("Eyeglasses"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_surround_sound",
        display_name=__("Audio technician"),
        joke_category=JNJokeCategories.corny
    ))
    __registerJoke(JNJoke(
        label="joke_rose_thorns",
        display_name=__("Roses"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_acrobats_somersault",
        display_name=__("Acrobats"),
        joke_category=JNJokeCategories.neutral
    ))
    __registerJoke(JNJoke(
        label="joke_frog_seating",
        display_name=__("Frog seating"),
        joke_category=JNJokeCategories.corny
    ))
