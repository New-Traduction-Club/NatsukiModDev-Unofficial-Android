...
label player_apologies_start:
    ...
    call screen scrollable_choice_menu(apologies_menu_items, (__("Go back"), None), 400, "mod_assets/icons/apologies.png")
...
init 5 python:
    registerTopic(
        Topic(
            ...
            prompt=__("For calling you a hurtful name."),
...
init 5 python:
    registerTopic(
        Topic(
            persistent._apology_database,
            prompt=__("For cheating during our games."),
...
init 5 python:
    registerTopic(
        Topic(
            persistent._apology_database,
            prompt=__("For being rude to you."),
            label="apology_rude",
            unlocked=True,
        ),
        topic_group=TOPIC_TYPE_APOLOGY
...
init 5 python:
    registerTopic(
        Topic(
            persistent._apology_database,
            prompt=__("For leaving without saying goodbye."),
...
init 5 python:
    registerTopic(
        Topic(
            persistent._apology_database,
            prompt=__("For not taking care of myself properly."),
...
init 5 python:
    registerTopic(
        Topic(
            persistent._apology_database,
            prompt=__("For asking you to call me a bad name."),
