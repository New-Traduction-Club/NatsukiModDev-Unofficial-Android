...
init python in jn_farewells:
    ...
    def getFarewellOptions():
        ...
        """
        return [
            (__("I'm going to sleep."), "farewell_option_sleep"),
            (__("I'm going to go eat something."), "farewell_option_eat"),
            (__("I'm going out somewhere."), "farewell_option_going_out"),
            (__("I'm going to work."), "farewell_option_work"),
            (__("I'm going to school."), "farewell_option_school"),
            (__("I'm going to play something else."), "farewell_option_play"),
            (__("I'm going to do some studying."), "farewell_option_studying"),
            (__("I'm going to do something else."), "farewell_option_misc_activity"),
            (__("I'm going to do some chores."), "farewell_option_chores"),
            (__("I'm going away for a while."), "farewell_option_extended_leave")
        ]
